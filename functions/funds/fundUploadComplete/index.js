...
export const handler = async (event) => {
  ...
  try {
    ...
    const { DYNAMODB_TABLE, BUCKET_NAME, ASSETS_BUCKET, SQS_QUEUE_URL } = process.env;

    if (!DYNAMODB_TABLE || !BUCKET_NAME || !ASSETS_BUCKET || !SQS_QUEUE_URL) {
    ...
    const payload = {
      ...
      schemaPath: `s3://${ASSETS_BUCKET}/assets/RulesEngineJSONSchema.txt`,
